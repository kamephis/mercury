        ...
        <div class="fixNav">
            <div class="row">
                <div class="navbar navbar-right">
                    ...
                    <div class="col-xs-12">
                        <button type="submit" class="btn btn-success btn-block bnt-lg" style="height:90px!important;"
                    ...
                    <small>&nbsp;</small>
                    <div class="col-xs-12">
                        <button type="submit" class="btn btn-default btn-block bnt-lg" style="height:90px!important;"
